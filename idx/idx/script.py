...
drop_cols = ["delinq_2yrs", "revol_bal", "out_prncp", "total_pymnt", "total_rec_prncp", "total_rec_int", "total_rec_late_fee", "recoveries", "collection_recovery_fee", "last_pymnt_d", "last_pymnt_amnt", "next_pymnt_d"]
...
drop_cols = ["id", "member_id", "funded_amnt","emp_title", "url", "desc", "title", "zip_code", "out_prncp_inv", "total_pymnt_inv", "last_credit_pull_d", "pymnt_plan"]
df.drop(drop_cols, axis=1, inplace=True)
...
df['int_rate_cat'] = pd.cut(df['int_rate'], bins=bins, labels=['0-5', '5-10', '10-15', '15-20', '20-25', '25-30'])
...
df_dummies=pd.get_dummies(df_cat[['home_ownership','grade','verification_status','term_months', 'initial_list_status']],drop_first=True)
df_dummies.shape
